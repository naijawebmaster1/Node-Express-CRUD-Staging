...
app.get('/', (req, res) => {
    ...
    res.send([{
        status: 'Success',
        Message: 'Payload for Products Endpoints',
        Data: product
    }]);
...
app.get('/api/products', (req, res) => {
    ...
    res.send(response);
    console.log(`Successfully Got all product`)
});
...
app.post('/api/products', (req, res) => {
    ...
    res.send(response);
    console.log(`product ${products.length} Successfully added`)
...
app.get('/api/products/:id', (req, res) => {
    ...
    if (!product) {
        ...
        response = [{
            Status: 'Success',
            Message: `Product ID of ${req.params.id} Successfully Retrieved`,
            Data: product
        }];

        res.send(response);
        console.log(`Successfully Got product with id of ${req.params.id}`)
    }
});
...
app.put('/api/products/:id', (req, res) => {
    ...
    if (!product) {
        ...
        response = [{
            Status: 'Success',
            Message: `Product ID of ${req.params.id} Successfully Updated`,
            Data: product
        }];

        res.send(response);
        console.log(`Successfully updated product with id of ${req.params.id}`)
    }
});
...
app.delete('/api/products/:id', (req, res) => {
    ...
    if (!product) {
        ...
        response = [{
            Status: 'Success',
            Message: `Product ID of ${req.params.id} Successfully Deleted`,
            Data: product
        }];

        res.send(response);
        console.log(`Successfully deleted product with id of ${req.params.id}`)
    }
});

app.get('/api/:products/:year/:id', (req, res) => {

    const parameters = req.params;
    const query = req.query;
    const response = {
            Status: 'Success',
            Message: `Successfully got parameter and query`,
